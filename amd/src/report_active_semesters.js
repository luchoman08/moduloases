...
define([
    ...
    function init_datatable (cohort_id, instance_id) {
        var url = '../managers/report_active_semesters/report_active_semesters_api.php';
    ...
    return {
        init: function (data) {
            ...
            $('#cohorts').change(function() {
                ...
                init_datatable(cohort_id, instance_id);
            });
            /* First table init */
            var cohort_id = $('#cohorts option:selected').val();
            init_datatable(cohort_id, instance_id);
